...
export default function Banner () {
  return (
    <>
      <div id='inicio' className='bg-banner container-fluid pb-4 pt-0 pt-sm-5 pb-sm-5 mb-sm-3'>
            ...
            <div className='col-sm-6 d-flex align-items-center bg-title'>
              <div className='card-body'>
                ...
                <div className='d-grid gap-2 d-sm-flex justify-content-sm-start mt-3'>
                  <a type='button' className='btn btn-secondary' href='#proyectos'>Mira mis proyectos</a>
                  <a type='button' className='btn btn-outline-primary d-none d-sm-block' href='#contacto'>Trabajemos juntos&nbsp;
